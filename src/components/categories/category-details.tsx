...
export function CategoryInfoDialog({
    ...
    const createdDate = category._creationTime ? new Date(category._creationTime) : null
    const department = departments?.find(d => d._id === category.departmentId)
                ...
                <div className="px-6 py-4 space-y-5">
                    ...
                    <div className="space-y-2 text-sm">
                        ...
                        <div className="flex items-center gap-2 text-muted-foreground">
                            ...
                            <span>Department: <span className="font-medium">{department?.name || 'Unknown'}</span></span>
                        </div>
                    </div>
