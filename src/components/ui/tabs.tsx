  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "data-active:bg-primary data-active:text-white data-active:border-primary dark:data-active:bg-primary dark:data-active:border-primary dark:data-active:text-white",
